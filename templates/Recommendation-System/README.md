...
Shloka Recommendation System recommends shlokas similar to the shloka user likes.

The details of the shlokas(Id, Shloka, Word-meaning, Translation, Purport, etc) are fetched from the data collected from https://vedabase.io/en/ .
<!-- 
